...
vulcanize px-dropdown-chevron-demo.html -o px-dropdown-chevron-demo.vulcanized.html --inline-scripts --inline-css --strip-comments
vulcanize px-dropdown-content-demo.html -o px-dropdown-content-demo.vulcanized.html --inline-scripts --inline-css --strip-comments
vulcanize px-dropdown-text-demo.html -o px-dropdown-text-demo.vulcanized.html --inline-scripts --inline-css --strip-comments
yes | cp index.vulcanized.html index.html
yes | cp px-dropdown-chevron-demo.vulcanized.html px-dropdown-chevron-demo.html
yes | cp px-dropdown-content-demo.vulcanized.html px-dropdown-content-demo.html
yes | cp px-dropdown-text-demo.vulcanized.html px-dropdown-text-demo.html
rm index.vulcanized.html
rm px-dropdown-chevron-demo.vulcanized.html;
rm px-dropdown-content-demo.vulcanized.html;
rm px-dropdown-text-demo.vulcanized.html;
