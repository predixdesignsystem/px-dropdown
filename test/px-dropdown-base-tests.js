...
function runBaseTests() {
  px_dropdown_1 = document.getElementById('px_dropdown_1');

  suite('Base Automation Tests for px-dropdown', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-dropdown fixture is created', function() {
      assert.isTrue(document.getElementById('px_dropdown_1') !== null);
    });
